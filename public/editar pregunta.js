...
const selectCrear = document
	.querySelector('.crearCategoriasYaExistentes')
	.addEventListener('change', crearPonerSelect);
...
const selectEdit = document
	.querySelector('.editarCategoriaYaExistente')
	.addEventListener('change', editarPonerSelect);
...
function lasCategoriasSelect() {
	...
	const crearSelect = (document.querySelector(
		'.crearCategoriasYaExistentes'
	).innerHTML = saveSelectHTML);
	const editarSelect = (document.querySelector(
		'.editarCategoriaYaExistente'
	).innerHTML = saveSelectHTML);
}

setTimeout(lasCategoriasSelect, 2000);

const formcreate = document
	.querySelector('#crearForm')
